package com.mansour.task.framework.utils.ext

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.mansour.task.business.entities.errors.ErrorMessage
import com.mansour.task.business.entities.errors.ErrorTypes
import com.mansour.task.business.entities.errors.ErrorTypes.*
import com.mansour.task.business.entities.errors.ServerError
...
private fun getHttpError(throwable: HttpException): ErrorMessage {
    ...
    throwable.response()?.errorBody()?.let {
        message = try {
            gson.fromJson<ServerError>(it.string(), type)?.fault?.message
        } catch (e: Exception) {
            null
        }
    }
